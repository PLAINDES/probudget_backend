                        ...
                        if ($ids) {
                                ...
                                if (!empty($presupuestos)) {
                                        ...
                                        if (count($object)) {
                                                ...
                                                if ($object->metrado) $var["metrado"] = $object->metrado;
                                                if ($object->cu) $var["cu"] = $object->cu;
                                                if ($object->mo) $var["mo"] = $object->mo;
                                                if ($object->mt) $var["mt"] = $object->mt;
                                                if ($object->eq) $var["eq"] = $object->eq;
                                                if ($object->sc) $var["sc"] = $object->sc;
                                                if ($object->sp) $var["sp"] = $object->sp;

                                                if ($object->unidad_medidas_id) $var["unidad_medidas_id"] = $object->unidad_medidas_id;
                                                if ($object->presupuestos_title_id) $var["presupuestos_title_id"] = $object->presupuestos_title_id;
                                                if ($object->partidas_id) $var["partidas_id"] = $object->partidas_id;

                                                if ($object->subpresupuestos_id) $var["subpresupuestos_id"] = $object->subpresupuestos_id;
                                                if ($object->type_item) {
                                                ...
                                                if ($object->type_item == 3) $this->partidas[$object->id] = $insert["lastInsertId"];
        ...
        private function setVerificarPresupuesto($searchedValue, $dataPresupuesto, $id, &$data)
        {
                ...
                if (count($object)) {
                        foreach ($object as $value) {
                                ...
                                if ($value->presupuestos_title_id) $var["presupuestos_title_id"] = $value->presupuestos_title_id;
                                if ($value->partidas_id) $var["partidas_id"] = $value->partidas_id;
        ...
        private function getInsertApus()
        {
                ...
                if ($apus_partida_presupuestos) {
                        foreach ($apus_partida_presupuestos as  $value) {
                                ...
                                if ($value->partida_id) $var["partida_id"] = $value->partida_id;
        ...
        private function getInsertPartidasPresupuestos()
        {
                ...
                if ($presupuestos_partida) {
                        foreach ($presupuestos_partida as  $value) {
                                ...
                                if ($value->proyectos_generales_id) $var["proyectos_generales_id"] = $value->proyectos_generales_id;
                                if ($value->subpartida_id) $var["subpartida_id"] = $this->subpartidas[$value->subpartida_id];
                                if ($value->partida_id) $var["partida_id"] = $value->partida_id;
